export const messages = {
   /* » WARNNING ...  */
   WARNING_FIELD_FILE_EMPTY: '¡No ha seleccionado un archivo!',
   WARNING_EMPTY: '¡No hay registros para mostrar!',
   /* » ERROR ...  */
   ERROR_INTERNAL_SERVER: '¡Ha ocurrido un error intentelo de nuevo!',

   /* ► ASSIGN'S ...  */
   ALL_RANGES_ASSIGNED: '¡No hay rangos disponibles!',
